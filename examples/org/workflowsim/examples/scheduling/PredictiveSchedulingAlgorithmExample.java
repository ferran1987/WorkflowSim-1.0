 ...
 * @date Nov 9, 2013
 */
public class PredictiveSchedulingAlgorithmExample extends DHEFTPlanningAlgorithmExample1 {
    ...
    public static void main(String[] args) {
        ...
        try {
             ...
             */
            Parameters.SchedulingAlgorithm sch_method = Parameters.SchedulingAlgorithm.PREDICT;
            ...
            for (Job jb : outputList0 ){
            	tt = jb.getCloudletId();
            	Log.printLine("jb: " + jb.getExecStartTime() + " Length: " + jb.getCloudletLength());
            }
            if (Parameters.getSchedulingAlgorithm() == Parameters.SchedulingAlgorithm.PREDICT) {
            	Log.printLine("test: "+Parameters.getSchedulingAlgorithm() + "es igual y " + "cantidad de trabajos: " + outputList0.size());}
        } catch (Exception e) {
